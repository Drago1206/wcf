...
namespace WcfDocTrans
{
    ...
    public class DocTrans : IDocTrans
    {
        ...
        public RespuestaTrazabilidad GetTrazabilida(DtTrazabilidad DtTrazabilidad)
        {
            ...
            List<DatosTrazabilidad> Trazabilidad = new List<DatosTrazabilidad>();
            ...
            else
            {
                ...
                if (dateTimeOffset > DateTime.Now)
                {
                    ...
                    {
                        Trazabilidad = con.DataTableToList<DatosTrazabilidad>("TipoDocumento,Numero,Compania,Fecha,Valor,Placa,Modelo,ClaseVeh,IdConductor,NomConductor,GPSoperador,GPSUsuario,GPSClave,FechaInicioCargue,HoraInicioCargue,FechaFinCargue,HoraFinCargue,FechaSalida,HoraSalida,Precinto".Split(','), Tablainfo);
                        Trazabilidad.ForEach(m =>
                        {
                        ...
                        respuesta.Respuesta = Trazabilidad;
                    }
                    else
                    {
                        respuesta.Errores = new Errores { Codigo = "001", Descripcion = "No se pudo obtener los datos" };
        ...
        public RespuestaPedido SetPedido(DtPedido DtPedido)
        {
            ...
            DtPedido.Conceptos = new List<Conceptos>();
            ...
            try
            {
                ...
                if (dateTimeOffset > DateTime.Now)
                {
                    ...
                    else
                    {
                        ...
                        con.ejecutarProcedimiento("WcfPedidosTrasn_ObtenerPedido");
                        if ((con.ejecutarQuery("WSPedidosTrans_ObtenerPedido", parametros, out Tablainfo, out string[] nuevomennsaje, CommandType.StoredProcedure))
                        {
                            respuesta.Errores = new Errores {Codigo = "002", Descripcion="Se ejecuto correctamente la consulta" };

                        }
                        //Tablainfo = con.getDataSet();
                       // {
                    ...
                    respuesta.Errores = new Errores { Codigo = "001", Descripcion = "El token ya no es valido!!, vuelve a generarlo" };
